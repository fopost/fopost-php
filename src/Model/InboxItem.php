...
final class InboxItem extends Model
{
    ...
    private function __construct(
        ...
        public readonly ?bool $canLike,
        public readonly ?bool $canVote,
        public readonly ?bool $canPin,
    ...
    public static function fromArray(mixed $data): static
    {
        ...
        return new self(
            ...
            self::bool($data, 'liked'),
            self::str($data, 'vote'),
            self::bool($data, 'pinned'),
            self::str($data, 'reaction'),
            self::date($data, 'edited_at'),
            self::bool($data, 'can_like'),
            self::bool($data, 'can_vote'),
            self::bool($data, 'can_pin'),
            self::bool($data, 'can_edit'),
            self::bool($data, 'can_react'),
